...
This template does not include any kind of persistence (database). For more advanced examples, check out the  which includes Typescript, Mongo, DynamoDB and other examples.
